...
print.heritability.table <- function(digits, h2, simulation = T) {
  ...
  #' and standard deviation. Works for both application and simulation
  #' @param digits Number of significant digits
  #' @param h2 Heritability DF with different scales
  #' @param simulation Simulation flag for the table's LaTeX label
  #' @return None (invisible `NULL`)
  texlabel <- ifelse(simulation, "\\label{tab:heritability simulation}",
  ...
  write(paste(header, main, footer, sep = "\n"),
        file=paste0("../figures/", texlabel, ".tex"))
}
