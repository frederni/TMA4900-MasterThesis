...
texfont <- "CMU Serif"
theme_set(theme_gray(text = element_text(family=texfont), base_size = 14))
...
df <- data.frame(x = rnorm(50), y = rnorm(50), group = factor(sample(1:4, 50, replace = TRUE)))
...
ggplot(df, aes(x = x, y = y, color = group)) +
  ...
  labs(x = "X Axis", y = "Y Axis", color = "Group") +
