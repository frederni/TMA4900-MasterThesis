...
Further, we quantitatively look into estimates for different $\sigma^2_A$:
...
markov.plotter <- function(df, legend.name=""){
  ggplot(df, aes(x=xax)) +
    ...
    theme(text = element_text(size = 18), legend.postion = "none") 
}
load("markovh2dev_50_runs.Rdata")
mp1 <- markov.plotter(markov_result1)
mp2 <- markov.plotter(markov_result2)
mp3 <- markov.plotter(markov_result3,
...
Now we want to look into how $\mathbf{A}$ (the relatedness matrix) looks like.
