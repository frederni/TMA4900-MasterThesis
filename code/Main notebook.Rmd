...
plot.h2.deviation <- function(
  ...
  #' @param sigma.sclae either "log" or "small", deciding what values, and the
...
cat("\n-\nRuntime for No averaging:",
    difftime(Sys.time(), ti, units = "secs"), "secs.\n")
h2.psi.sparrow$phi <- get.h2(fit.inla.probit, n.samples, model="binom1.probit",
                             use.scale=TRUE)
```
...
print.heritability.table <- function(digits, h2appl, h2sim) {
  ...
  #' and standard deviation. Does it for the application and simulation run.
  #' @param digits Number of significant digits
  #' @param h2appl Heritability DF with different scales, for application data
  #' @param h2sim Heritability DF with different scales, for simulation data
  #' @return None (invisible `NULL`)
  header <- paste(
