...
plot.h2.deviation <- function(dichotomize="round",
  ...
  for(sigmaA in sigmaA.list){
    ...
    simulation.h2.true <- sigmaA/(sigmaA+1+0.25)
...
ggplot(data=temp$res, aes(x=sigmaA)) + geom_line(aes(y=true.vals*0.25), color="darkred") +
  geom_line(aes(y=estimates),color="steelblue")  + xlim(c(0,1))
