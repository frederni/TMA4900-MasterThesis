...
paste(c("Number not survived:", "Number survived:"), table(qg.data.gg.inds$surv.ind.to.ad))
paste("natal year correlation:", cor(qg.data.gg.inds$natalyr, qg.data.gg.inds$natalyr.no))
paste("correlation between sex and sex.x1:", cor(qg.data.gg.inds$sex.use, qg.data.gg.inds$sex.use.x1))
```
